    ...
    <div className="min-h-screen bg-gray-100">
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Editar Bebida</h1>
            <p className="text-sm text-gray-600">Actualizar información del producto</p>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6 space-y-6">
          ...
          <div className="border-t pt-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Costo por Caja *</label>
          ...
          <div className="flex gap-3 pt-4 border-t">
            ...
            >
              <Save size={20} />
              {isLoading ? 'Guardando...' : 'Actualizar Bebida'}
            </button>
          </div>
        </form>
      </main>
